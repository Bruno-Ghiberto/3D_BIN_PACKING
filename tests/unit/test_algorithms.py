...
class TestFirstFitDecreasingPacker:
    ...
    def test_pack_multiple_boxes(self, default_config: PackerConfig, sample_boxes: list[Box]) -> None:
    ...
    def test_utilization_calculated(self, default_config: PackerConfig, sample_boxes: list[Box]) -> None:
...
class TestAlgorithmComparison:
    ...
    def test_both_pack_same_boxes(self, default_config: PackerConfig, sample_boxes: list[Box]) -> None:
