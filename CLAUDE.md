...
This repository is governed by the project constitution at
[`.specify/memory/constitution.md`](.specify/memory/constitution.md). All
planning, implementation, and review work MUST comply with its 8 Core
Principles — 4 of which are **NON-NEGOTIABLE** (Contract Honesty,
Test-First Discipline, Automated Quality Gates, Documentation). See the
Sync Impact Report at the top of the constitution for amendment history.
